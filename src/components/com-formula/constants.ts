...
export const FUNCTIONS_TYPE = [
  ...
  // },
  {
    cateName: I18nStore.getIntl('mathFun'),
    cateValue: 'math',
  },
  // {
...
export const FUNCTIONS_DATA: { [index: string]: FunctionConfig[] } = {
  ...
  math: [
    {
      label: I18nStore.getIntl('math0label'),
      name: 'ABS()',
      intro: I18nStore.getIntl('math0intro'),
      usage: I18nStore.getIntl('math0usage'),
      example: I18nStore.getIntl('math0example'),
    },
    {
      label: I18nStore.getIntl('math1label'),
      name: 'AVERAGE()',
      intro: I18nStore.getIntl('math1intro'),
      usage: I18nStore.getIntl('math1usage'),
      example: I18nStore.getIntl('math1example'),
    },
    {
      label: I18nStore.getIntl('math2label'),
      name: 'COUNT()',
      intro: I18nStore.getIntl('math2intro'),
      usage: I18nStore.getIntl('math2usage'),
      example: I18nStore.getIntl('math2example'),
    },
    {
      label: I18nStore.getIntl('math3label'),
      name: 'FIXED()',
      intro: I18nStore.getIntl('math3intro'),
      usage: I18nStore.getIntl('math3usage'),
      example: I18nStore.getIntl('math3example'),
    },
    {
      label: I18nStore.getIntl('math4label'),
      name: 'INT()',
      intro: I18nStore.getIntl('math4intro'),
      usage: I18nStore.getIntl('math4usage'),
      example: I18nStore.getIntl('math4example'),
    },
    {
      label: I18nStore.getIntl('math5label'),
      name: 'LOG()',
      intro: I18nStore.getIntl('math5intro'),
      usage: I18nStore.getIntl('math5usage'),
      example: I18nStore.getIntl('math5example'),
    },
    {
      label: I18nStore.getIntl('math6label'),
      name: 'MOD()',
      intro: I18nStore.getIntl('math6intro'),
      usage: I18nStore.getIntl('math6usage'),
      example: I18nStore.getIntl('math6example'),
    },
    {
      label: I18nStore.getIntl('math7label'),
      name: 'MAX()',
      intro: I18nStore.getIntl('math7intro'),
      usage: I18nStore.getIntl('math7usage'),
      example: I18nStore.getIntl('math7example'),
    },
    {
      label: I18nStore.getIntl('math8label'),
      name: 'MIN()',
      intro: I18nStore.getIntl('math8intro'),
      usage: I18nStore.getIntl('math8usage'),
      example: I18nStore.getIntl('math8example'),
    },
    {
      label: I18nStore.getIntl('math9label'),
      name: 'POWER()',
      intro: I18nStore.getIntl('math9intro'),
      usage: I18nStore.getIntl('math9usage'),
      example: I18nStore.getIntl('math9example'),
    },
    {
      label: I18nStore.getIntl('math10label'),
      name: 'PRODUCT()',
      intro: I18nStore.getIntl('math10intro'),
      usage: I18nStore.getIntl('math10usage'),
      example: I18nStore.getIntl('math10example'),
    },
    // {
    //   label: I18nStore.getIntl('math14label'),
    //   name: 'RANDOM()',
    //   intro: I18nStore.getIntl('math14intro'),
    //   usage: I18nStore.getIntl('math14usage'),
    //   example: I18nStore.getIntl('math14example'),
    // },
    {
      label: I18nStore.getIntl('math11label'),
      name: 'SQRT()',
      intro: I18nStore.getIntl('math11intro'),
      usage: I18nStore.getIntl('math11usage'),
      example: I18nStore.getIntl('math11example'),
    },
    {
      label: I18nStore.getIntl('math12label'),
      name: 'SUM()',
      intro: I18nStore.getIntl('math12intro'),
      usage: I18nStore.getIntl('math12usage'),
      example: I18nStore.getIntl('math12example'),
    },
    // {
    //   label: I18nStore.getIntl('math13label'),
    //   name: 'SUMPRODUCT()',
    //   intro: I18nStore.getIntl('math13intro'),
    //   usage: I18nStore.getIntl('math13usage'),
    //   example: I18nStore.getIntl('math13example'),
    // },
  ],
  // date: [
  //   {
