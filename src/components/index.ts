...
export { default as ComPagination } from './com-pagination';
...
export { default as ComTable } from './com-table';
...
export { default as ComPaginationNav } from './pagination-nav';
