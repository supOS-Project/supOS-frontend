...
import { FUNCTION_TYPES } from '@/pages/uns/components/use-create-modal/step2/timeSeries/FunctionConfig';
...
const FunctionList: FC<any> = () => {
  ...
  const onChange = (e: any, options: any) => {
    const { fields } = options.find((option: any) => option.topic === e) || {};
  ...
  return (
    <>
      ...
      >
        <SearchSelect onChange={onChange} />
      </Form.Item>
