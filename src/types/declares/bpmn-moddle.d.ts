declare module 'bpmn-moddle' {
  ...
  // bpmn.json 原始类型
  export type RootElement = BaseElement;
  ...
  export type EndPoint = RootElement;
  export type Auditing = BaseElement;
  export interface GlobalTask extends CallableElement {
    resources?: ResourceRole[];
  }
  export type Monitoring = BaseElement;
  export type Performer = ResourceRole;
  ...
  export type GlobalManualTask = GlobalTask;
  export type ManualTask = Task;
  export interface UserTask extends Task {
    renderings?: Rendering[];
    implementation?: string;
  }
  export type Rendering = BaseElement;
  export type HumanPerformer = Performer;
  export type PotentialOwner = HumanPerformer;
  ...
  export type ParallelGateway = Gateway;
  ...
  export type IntermediateCatchEvent = CatchEvent;
  export type IntermediateThrowEvent = ThrowEvent;
  export type EndEvent = ThrowEvent;
  ...
  export type EventDefinition = RootElement;
  export type CancelEventDefinition = EventDefinition;
  ...
  export type ImplicitThrowEvent = ThrowEvent;
  ...
  export type DataInputAssociation = DataAssociation;
  export type DataOutputAssociation = DataAssociation;
  ...
  export type Conversation = ConversationNode;
  ...
  export type GlobalConversation = Collaboration;
  ...
  export type Artifact = BaseElement;
  ...
  export type LoopCharacteristics = BaseElement;
